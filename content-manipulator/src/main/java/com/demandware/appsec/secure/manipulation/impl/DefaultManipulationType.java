...
/**
 * The Default Manipulation Types are the standard manipulators bundled with this library. They pre-configure each
 * Manipulator in preparation for use with the ManipulatorFactory.
 * 
 * @author Chris Smith
 */
