...
public class _SecureEncoder
{
    ...
    public void HTMLTest()
    {
        ...
        String htmlContent = "&lt;!--this! is/ a; comment: --&gt;&lt;foo attribute=value&gt;text&lt;/foo&gt;&lt;bar attribute=&quot;doublevalue&quot;&gt;text2&lt;/bar&gt;&lt;baz attribute=&#x27;singlevalue&#x27;&gt;)(*#$!@#?&lt;/baz&gt;";
        assertEquals(
            "encodeHTMLContent failed",
            htmlContent,
            SecureEncoder.encodeHtmlContent( htmlTest ) );
        ...
        String htmlDouble = "&lt;!--this! is/ a; comment: --&gt;&lt;foo attribute=value&gt;text&lt;/foo&gt;&lt;bar attribute=&quot;doublevalue&quot;&gt;text2&lt;/bar&gt;&lt;baz attribute='singlevalue'&gt;)(*#$!@#?&lt;/baz&gt;";
        assertEquals(
            "encodeHtmlInDoubleQuoteAttribute failed",
            htmlDouble,
        ...
        sw = new StringWriter(htmlTest.length() * 2);
        String htmlSingle = "&lt;!--this! is/ a; comment: --&gt;&lt;foo attribute=value&gt;text&lt;/foo&gt;&lt;bar attribute=\"doublevalue\"&gt;text2&lt;/bar&gt;&lt;baz attribute=&#x27;singlevalue&#x27;&gt;)(*#$!@#?&lt;/baz&gt;";
        assertEquals(
            "encodeHtmlInSingleQuoteAttribute failed",
            htmlSingle,
        ...
        sw = new StringWriter(htmlTest.length() * 2);
        String htmlUnq = "&lt;!--this!&#x20;is/&#x20;a;&#x20;comment:&#x20;--&gt;&lt;foo&#x20;attribute=value&gt;text&lt;/foo&gt;&lt;bar&#x20;attribute=&quot;doublevalue&quot;&gt;text2&lt;/bar&gt;&lt;baz&#x20;attribute=&#x27;singlevalue&#x27;&gt;)(*#$!@#?&lt;/baz&gt;";
        assertEquals(
            "encodeHtmlUnquotedAttribute failed",
            htmlUnq,
    ...
    public void XMLTest()
    {
        ...
        String xmlContent = "&lt;&#x21;--this&#x21; is&#x2f; a; comment: --&gt;&lt;foo attribute&#x3d;value&gt;text&lt;&#x2f;foo&gt;&lt;bar attribute&#x3d;&quot;doublevalue&quot;&gt;text2&lt;&#x2f;bar&gt;&lt;baz attribute&#x3d;&apos;singlevalue&apos;&gt;)(&#x2a;&#x23;&#x24;&#x21;&#x40;&#x23;&#x3f;&lt;&#x2f;baz&gt;";
        assertEquals(
            "encodeXmlContent failed",
            xmlContent,
            SecureEncoder.encodeXmlContent( xmlTest ) );
        ...
        String xmlDouble = "&lt;&#x21;--this&#x21; is&#x2f; a; comment: --&gt;&lt;foo attribute&#x3d;value&gt;text&lt;&#x2f;foo&gt;&lt;bar attribute&#x3d;&quot;doublevalue&quot;&gt;text2&lt;&#x2f;bar&gt;&lt;baz attribute&#x3d;'singlevalue'&gt;)(&#x2a;&#x23;&#x24;&#x21;&#x40;&#x23;&#x3f;&lt;&#x2f;baz&gt;";
        assertEquals(
            "encodeXmlInDoubleQuoteAttribute failed",
            xmlDouble,
        ...
        sw = new StringWriter(xmlTest.length() * 2);
        String xmlSingle = "&lt;&#x21;--this&#x21; is&#x2f; a; comment: --&gt;&lt;foo attribute&#x3d;value&gt;text&lt;&#x2f;foo&gt;&lt;bar attribute&#x3d;\"doublevalue\"&gt;text2&lt;&#x2f;bar&gt;&lt;baz attribute&#x3d;&apos;singlevalue&apos;&gt;)(&#x2a;&#x23;&#x24;&#x21;&#x40;&#x23;&#x3f;&lt;&#x2f;baz&gt;";
        assertEquals(
            "encodeXmlInSingleQuoteAttribute failed",
            xmlSingle,
        ...
        assertEquals(
            "encodeXmlComment failed",
            xmlComment,
            SecureEncoder.encodeXmlCommentContent( xmlTest ) );
    ...
    public void JavaScriptTest()
    {
        ...
        String jsHTML = "console.log(\\x22Log Message!\\x22);\\r\\n $(ajax).postMessage(\\x27foo.com\\x27);\\nvar x = 123+14*82\\/12\\-6;";
        assertEquals(
            "encodeJavaScriptInHTML failed",
            jsHTML,
            SecureEncoder.encodeJavaScriptInHTML( javascriptTest ) );
        ...
        sw = new StringWriter(javascriptTest.length() * 2);
        String jsBlock = "console.log(\\\"Log Message!\\\");\\r\\n $(ajax).postMessage(\\'foo.com\\');\\nvar x = 123+14*82\\/12\\-6;";
        assertEquals(
            "encodeJavaScriptInBlock failed",
            jsBlock,
        ...
        sw = new StringWriter(javascriptTest.length() * 2);
        String jsSource = "console.log(\\\"Log Message!\\\");\\r\\n $(ajax).postMessage(\\'foo.com\\');\\nvar x = 123+14*82/12-6;";
        assertEquals(
            "encodeJavaScriptInSource failed",
            jsSource,
    ...
    public void JSONTest()
    {
        ...
        assertEquals(
            "encodeJSONValue failed",
            json,
            SecureEncoder.encodeJSONValue( jsonValues ) );
    ...
    public void URITest()
    {
        ...
        assertEquals(
            "encodeUriComponent failed",
            uriComp,
            SecureEncoder.encodeUriComponent( URI ) );
        ...
        assertEquals(
            "encodeUriComponentStrict failed",
            uriStrict,
            SecureEncoder.encodeUriComponentStrict( URI ) );
