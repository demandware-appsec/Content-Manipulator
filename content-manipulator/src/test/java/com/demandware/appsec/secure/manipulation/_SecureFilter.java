...
public class _SecureFilter
{
    ...
    public void HTMLTest()
    {
        ...
        String htmlContent = "!--this! is/ a; comment: --foo attribute=valuetext/foobar attribute=doublevaluetext2/barbaz attribute=singlevalue)(*#$!@#?/baz";
        assertEquals(
            "filterHTMLContent failed",
            htmlContent,
            SecureFilter.filterHtmlContent( htmlTest ) );
        ...
        String htmlDouble = "!--this! is/ a; comment: --foo attribute=valuetext/foobar attribute=doublevaluetext2/barbaz attribute='singlevalue')(*#$!@#?/baz";
        assertEquals(
            "filterHtmlInDoubleQuoteAttribute failed",
            htmlDouble,
        ...
        sw = new StringWriter(htmlTest.length() * 2);
        String htmlSingle = "!--this! is/ a; comment: --foo attribute=valuetext/foobar attribute=\"doublevalue\"text2/barbaz attribute=singlevalue)(*#$!@#?/baz";
        assertEquals(
            "filterHtmlInSingleQuoteAttribute failed",
            htmlSingle,
        ...
        sw = new StringWriter(htmlTest.length() * 2);
        String htmlUnq = "!--this!is/a;comment:--fooattribute=valuetext/foobarattribute=doublevaluetext2/barbazattribute=singlevalue)(*#$!@#?/baz";
        assertEquals(
            "filterHtmlUnquotedAttribute failed",
            htmlUnq,
    ...
    public void XMLTest()
    {
        ...
        String xmlContent = "--this is a; comment: --foo attributevaluetextfoobar attributedoublevaluetext2barbaz attributesinglevalue)(baz";
        assertEquals(
            "filterXmlContent failed",
            xmlContent,
            SecureFilter.filterXmlContent( xmlTest ) );
        ...
        String xmlDouble = "--this is a; comment: --foo attributevaluetextfoobar attributedoublevaluetext2barbaz attribute'singlevalue')(baz";
        assertEquals(
            "filterXmlInDoubleQuoteAttribute failed",
            xmlDouble,
        ...
        sw = new StringWriter(xmlTest.length() * 2);
        String xmlSingle = "--this is a; comment: --foo attributevaluetextfoobar attribute\"doublevalue\"text2barbaz attributesinglevalue)(baz";
        assertEquals(
            "filterXmlInSingleQuoteAttribute failed",
            xmlSingle,
        ...
        sw = new StringWriter(xmlTest.length() * 2);
        String xmlComment = "<!this! is/ a; comment: ><foo attribute=value>text</foo><bar attribute=\"doublevalue\">text2</bar><baz attribute='singlevalue'>)(*#$!@#?</baz>";
        assertEquals(
            "filterXmlComment failed",
            xmlComment,
            SecureFilter.filterXmlCommentContent( xmlTest ) );
    ...
    public void JavaScriptTest()
    {
        ...
        assertEquals(
            "filterJavaScriptInHTML failed",
            jsHTML,
            SecureFilter.filterJavaScriptInHTML( javascriptTest ) );
        ...
        assertEquals(
            "filterJavaScriptInAttribute failed",
            jsAttr,
        ...
        sw = new StringWriter(javascriptTest.length() * 2);String jsBlock = "console.log(Log Message!); $(ajax).postMessage(foo.com);var x = 123+14*82126;";
        assertEquals(
            "filterJavaScriptInBlock failed",
            jsBlock,
        ...
        sw = new StringWriter(javascriptTest.length() * 2);String jsSource = "console.log(Log Message!); $(ajax).postMessage(foo.com);var x = 123+14*82/12-6;";
        assertEquals(
            "filterJavaScriptInSource failed",
            jsSource,
    ...
    public void JSONTest()
    {
        ...
        assertEquals(
            "filterJSONValue failed",
            json,
            SecureFilter.filterJSONValue( jsonValues ) );
    ...
    public void URITest()
    {
        ...
        assertEquals(
            "filterUriComponent failed",
            uriComp,
            SecureFilter.filterUriComponent( URI ) );
        ...
        assertEquals(
            "filterUriComponentStrict failed",
            uriStrict,
            SecureFilter.filterUriComponentStrict( URI ) );
